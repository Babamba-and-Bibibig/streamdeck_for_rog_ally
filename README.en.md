...
The list shows **file names and changed text recorded for this question**, including changes captured before and after tools run on the Mac. Incomplete records show **Check file records**; a confirmed empty list shows **No file changes**. [File checks, retry and editor settings](docs/INSTALL.en.md#host-shortcuts).
...
**Set up the Mac → transfer the connection file → set up the Ally.** Current version: **0.1.29**.
