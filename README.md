...
<td width="50%">
<b>② 아래 버튼 · 수정 파일 목록</b><br>
<a href="docs/screenshots/files.png"><img src="docs/screenshots/files.png" alt="수정 파일명과 전체 경로 목록" width="640"></a><br>
먼저 파일명과 경로를 확인합니다. 목록에서 파일을 누르면 <b>Mac 편집기</b>가 기록된 변경 줄로 이동합니다.
</td>
</tr>
</table>
...
아래 버튼은 **이번 질의의 파일명·전체 경로·변경 줄 목록**을 엽니다. **목록에서 파일을 선택할 때 Mac 편집기가 열립니다.** 코드 내용은 Mac 편집기에서 확인하세요. Mac의 변경 이벤트로 바뀐 파일만 가져옵니다. 기록이 부족하면 **파일 정보 확인**, 편집이 없다고 확인되면 **파일 수정 없음**으로 표시합니다. [파일 확인·재시도와 편집기 설정](docs/INSTALL.md#host-shortcuts).
