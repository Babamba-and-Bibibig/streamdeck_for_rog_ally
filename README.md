...
파일 목록은 **이번 질의에 기록된 파일명과 변경 내용**을 보여줍니다. Mac의 변경 이벤트로 수정된 파일만 가져옵니다. Codex의 변경 내역과, 마지막으로 수집한 **현재 파일 내용**을 구분해서 보여줍니다. 기록이 부족하면 **파일 정보 확인**, 편집이 없다고 확인되면 **파일 수정 없음**으로 표시합니다. [파일 확인·재시도와 편집기 설정](docs/INSTALL.md#host-shortcuts).
...
**Mac 설치 → 연결 파일 옮기기 → Ally 설치**, 세 단계입니다. 현재 버전은 **0.1.31**입니다.
