...
Only the twelve screenshot paths above are permitted as public screenshots. PNGs have no ancillary metadata; SHA256 checks protect reviewed bytes in the Git index/history, ZIP and TAR exports. Review replacements visually and retain earlier approved hashes so historical revisions remain verifiable. A hash identifies reviewed bytes; it cannot establish the privacy of a new picture by itself.
